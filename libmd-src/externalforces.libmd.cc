...
template<ui dim> void externalforces<dim>::operator()(ui type,particle<dim> *p,vector<particle<dim>*> *particles,vector<ldf> *parameters,void *sys)
{
    extforces[type](p,particles,parameters,sys);
}
